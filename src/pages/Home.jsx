    ...
    <div className="w-full h-screen bg-black flex flex-row">
      ...
      <div className="w-full md:w-[50%] h-full flex justify-start items-center flex-col pt-[20px] md:pt-[120px] gap-[25px]">
        ...
        <div className="w-[80%] max-w-[250px] h-[240px] object-fill rounded-md overflow-hidden relative">
          <img src={songsData[index].image} alt="" className="w-full h-full" />
          {playingSong && (
      ...
      <div className=" w-[100%] md:w-[50%] h-[84%]  md:flex pt-[100px] flex-col gap-[18px] overflow-auto pb-[20px]">
        {songsData.map(song=><Card name={song.name} image={song.image} singer={song.singer} index={song-1}/>)}
      </div>
    </div>
  );
}
